		...
		<div class="row">
			<div class="col-md-12">
				<section class="boxs">
					...
					<div class="boxs-body">
						<form class="form-horizontal" name="form4" action="<?php echo site_url(); ?>/AdminController/cupdate/<?php echo $editData->admin_id; ?>" method="post" role="form" id="form4" data-parsley-validate>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="adminPwd" value="<?php echo $editData->admin_password ?>" placeholder="Admin Password" data-parsley-trigger="change" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="adminImg" value="<?php echo $editData->admin_profileimg ?>" placeholder="Admin Image" data-parsley-trigger="change" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="adminMob" value="<?php echo $editData->admin_mobile ?>" placeholder="Admi Mobile" data-parsley-trigger="change" required>
								</div>
							</div>
					</div>
