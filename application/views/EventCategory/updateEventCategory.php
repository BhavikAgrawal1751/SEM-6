				...
				<section class="boxs">
					<div class="boxs-header">
						<h3 class="custom-font hb-blush">
							<strong>Update</strong> EventCategory
						</h3>
					</div>
					<div class="boxs-body">
						<form class="form-horizontal" name="form4" action="<?php echo site_url(); ?>/EventCategoryController/cupdate/<?php echo $editData->eventcategory_id; ?>" method="post" role="form" id="form4" data-parsley-validate>
							<div class="form-group">
								<label class="col-sm-3 control-label">EventCategory Title</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" name="evCatTitle" value="<?php echo $editData->eventcategory_title; ?>" data-parsley-trigger="change" required>
								</div>
							</div>
					</div>
