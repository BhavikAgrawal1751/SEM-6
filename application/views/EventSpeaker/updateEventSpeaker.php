				...
				<section class="boxs">
					<div class="boxs-header">
						<h3 class="custom-font hb-blush">
							<strong>Update</strong> EventSpeaker
						</h3>
					</div>
					<div class="boxs-body">
						<form class="form-horizontal" name="form4" action="<?php echo site_url(); ?>/EventSpeakerController/cupdate/<?php echo $editData->eventspeaker_id ?>" method="post" role="form" id="form4" data-parsley-validate>
							...
							<div class="form-group">	
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="evSpeakName" value="<?php echo $editData->eventspeaker_name ?>" data-parsley-trigger="change" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="evSpeakPro" value="<?php echo $editData->eventspeaker_profession ?>" data-parsley-trigger="change" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="evSpeakImg" value="<?php echo $editData->eventspeaker_profileimg ?>" data-parsley-trigger="change" required>
								</div>
							</div>
					</div>
