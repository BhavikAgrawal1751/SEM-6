		...
		<div class="bg-light lter b-b wrapper-md mb-10">
			<div class="row">
				<div class="col-sm-6 col-xs-12">
					<h1 class="h3 m-0">FoodBeverageBooking Form</h1>
				</div>
			</div>
		</div>
		<!-- row -->
				...
				<section class="boxs">
					<div class="boxs-header">
						<h3 class="custom-font hb-blush">
							<strong>Add</strong> FoodBeverageBooking
						</h3>
					</div>
					<div class="boxs-body">
						<form class="form-horizontal" name="form4" action="<?php echo site_url(); ?>/FoodBeverageBookingController/cinsert/" method="post" role="form" id="form4" data-parsley-validate>
							<div class="form-group">
								<label class="col-sm-3 control-label">FoodBeverage Name</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" name="fbname" placeholder="FoodBeverage Name" data-parsley-trigger="change" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="fbprice" placeholder="FoodBeverage Price" data-parsley-trigger="change" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="fbimg" placeholder="FoodBeverage Image" data-parsley-trigger="change" required>
								</div>
							</div>
					</div>
