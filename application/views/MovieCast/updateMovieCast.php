		...
		<div class="bg-light lter b-b wrapper-md mb-10">
			<div class="row">
				<div class="col-sm-6 col-xs-12">
					<h1 class="h3 m-0">Moviecast Form</h1>
				</div>
			</div>
		</div>
		<!-- row -->
				...
				<section class="boxs">
					<div class="boxs-header">
						<h3 class="custom-font hb-blush">
							<strong>Update</strong> Moviecast
						</h3>
					</div>
					<div class="boxs-body">
						<form class="form-horizontal" name="form4" action="<?php echo site_url(); ?>/MoviecastController/cupdate/<?php echo $editData->cast_id ?>" method="post" role="form" id="form4" data-parsley-validate>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="castName" value="<?php echo $editData->cast_name ?>" data-parsley-trigger="change" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="castImg" value="<?php echo $editData->cast_img ?>" data-parsley-trigger="change" required>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" name="castPos" value="<?php echo $editData->cast_position ?>" data-parsley-trigger="change" required>
								</div>
							</div>
					</div>
