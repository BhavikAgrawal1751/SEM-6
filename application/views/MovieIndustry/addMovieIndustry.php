		...
		<div class="row">
			<div class="col-md-12">
				<section class="boxs">
					...
					<div class="boxs-body">
						<form class="form-horizontal" name="form4" action="<?php echo site_url(); ?>/MovieIndustryController/cinsert/" method="post" role="form" id="form4" data-parsley-validate>
							<div class="form-group">
								<label class="col-sm-3 control-label">Movie Industry Name</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" name="moIndName" placeholder="Movie Industry Name" data-parsley-trigger="change" required>
								</div>
							</div>
					</div>
