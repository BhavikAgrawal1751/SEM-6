		...
		<div class="bg-light lter b-b wrapper-md mb-10">
			<div class="row">
				<div class="col-sm-6 col-xs-12">
					<h1 class="h3 m-0">MovieIndustry Form</h1>
				</div>
			</div>
		</div>
		<!-- row -->
				...
				<section class="boxs">
					<div class="boxs-header">
						<h3 class="custom-font hb-blush">
							<strong>Add</strong> MovieIndustry
						</h3>
					</div>
					<div class="boxs-body">
						<form class="form-horizontal" name="form4" action="<?php echo site_url(); ?>/MovieIndustryController/cupdate/<?php echo $editData->industry_id ?>" method="post" role="form" id="form4" data-parsley-validate>
							<div class="form-group">
								<label class="col-sm-3 control-label">Movie Industry Name</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" name="moIndName" value="<?php echo $editData->industry_name ?>" data-parsley-trigger="change" required>
								</div>
							</div>
					</div>
