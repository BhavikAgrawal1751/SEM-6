								...
								<table id="searchTextResults" data-filter="#filter" data-page-size="5" class="footable table table-custom">
									...
									?>	
										<tr>
											...
											<td><a href="<?php echo site_url(); ?>/MovieSeatPlanController/status/<?php echo $row->seatplan_id ?>" class="btn btn-raised <?php echo ($row->seatplan_status == 'Blocked') ? 'btn-danger' : 'btn-success'; ?>"><?php echo $row->seatplan_status;?></a></td>
											<td><?php echo $row->seatplan_Dateregister;?></td>
											<td><a href="<?php echo site_url(); ?>/MovieSeatPlanController/delete/<?php echo $row->seatplan_id ?>" class="btn btn-raised btn-danger">Delete</a></td>
											<td><a href="<?php echo site_url(); ?>/MovieSeatPlanController/cedit/<?php echo $row->seatplan_id ?>" class="btn btn-raised btn-danger">Edit</a></td>
										</tr>
									<?php
										}
									?>
