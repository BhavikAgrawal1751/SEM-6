				...
				<div class="b-b mb-10">
					<div class="row">
						<div class="col-sm-6 col-xs-12">
							<h1 class="h3 m-0">MovieTicketBooking Table</h1>
						...
						<section class="boxs ">
							<div class="boxs-header">
								<h3 class="custom-font hb-cyan">
									<strong>MovieTicketBooking</strong> Table</h3>
								...
								<table id="searchTextResults" data-filter="#filter" data-page-size="5" class="footable table table-custom">
									<thead>
										<tr>
											...
											<th>Ticketbooking status</th>
											<th>Ticketbooking Dateregister</th>
											<th>Action</th>
										</tr>
									</thead>
									<tbody>
									...
									?>	
										<tr>
											...
											<td><a href="<?php echo site_url(); ?>/MovieTicketBookingController/status/<?php echo $row->ticketbooking_id ?>"><?php echo $row->ticketbooking_status;?></a></td>
											<td><?php echo $row->ticketbooking_Dateregister;?></td>
											<td><a href="<?php echo site_url(); ?>/MovieTicketBookingController/delete/<?php echo $row->ticketbooking_id ?>">Delete</a></td>
										</tr>
									<?php
										}
									?>
