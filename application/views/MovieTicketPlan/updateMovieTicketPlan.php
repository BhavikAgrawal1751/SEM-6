		...
		<div class="bg-light lter b-b wrapper-md mb-10">
			<div class="row">
				<div class="col-sm-6 col-xs-12">
					<h1 class="h3 m-0">MovieTicketPlan Form</h1>
				</div>
			</div>
		</div>
		<!-- row -->
				...
				<section class="boxs">
					<div class="boxs-header">
						<h3 class="custom-font hb-blush">
							<strong>Update</strong> MovieTicketPlan
						</h3>
					</div>
					<div class="boxs-body">
						<form class="form-horizontal" name="form4" action="<?php echo site_url(); ?>/MovieTicketPlanController/cupdate/<?php echo $editData->movieticket_id ?>" method="post" role="form" id="form4" data-parsley-validate>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="number" class="form-control" name="moTickTime" value="<?php echo $editData->movieticket_time ?>" data-parsley-trigger="change" required>
								</div>
							</div>

							<div class="form-group">
								<label class="col-sm-3 control-label">Movie Ticket Date</label>
								<div class="col-sm-9">
									<input type="text" class="form-control" name="moTickDate" value="<?php echo $editData->movieticket_date ?>" data-parsley-trigger="change" required>
								</div>
							</div>
					</div>
