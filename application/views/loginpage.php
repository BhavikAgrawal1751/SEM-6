        ...
        <div class="row">
          <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 text-center">
            <div class="card card-signup">
              <form class="form" method="post" action="<?php echo site_url(); ?>/LoginController/chklogin/">
                ...
                <div class="footer text-center">
                  <!-- <a href="<?php echo site_url(); ?>/LoginController/adminPanel/" class="btn btn-info btn-raised">Login</a> -->
